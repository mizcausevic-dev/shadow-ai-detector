...
### Released
- Published **shadow-ai-detector** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **shadow-ai-detector**.
...
- That insight became the basis for **shadow-ai-detector**.
